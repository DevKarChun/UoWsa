...
class StudentUnionNewForumActivity : AppCompatActivity() {

    private lateinit var auth: FirebaseAuth

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_student_union_new_forum)
        ...
        submitBtn.setOnClickListener {
            if (titleTxt.text.toString().isEmpty()){
                ...
                val intentStudy = Intent(this@StudentUnionNewForumActivity, ForumStudentUnionActivity::class.java)
    ...
    private fun createStudentUnionForum(title: String, description: String) {
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("StudentUnionForum")
