...
class DBGeneralProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dbgeneral_profile)
    ...
    private fun declineFriendList() {
        ...
        val intentFriendRequest = Intent(this, DBGeneralActivity::class.java)
