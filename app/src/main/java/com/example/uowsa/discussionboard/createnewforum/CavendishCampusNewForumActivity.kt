...
class CavendishCampusNewForumActivity : AppCompatActivity() {

    private lateinit var auth: FirebaseAuth

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cavendish_campus_new_forum)
        ...
        submitBtn.setOnClickListener {
            if (titleTxt.text.toString().isEmpty()){
                ...
                createCavendishCampusForum(title, description)
                val intentStudy = Intent(this@CavendishCampusNewForumActivity, ForumCavendishCampusActivity::class.java)
    ...
    private fun createCavendishCampusForum(title: String, description: String) {
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("CavendishCampusForum")
        Log.d("tagdatabaseref", databaseRef.toString())

        val newPost : HashMap <String, String> = HashMap()
        newPost["cavendishCampusCreatorId"] = userId
        newPost["cavendishCampusTitle"] = title
        newPost["cavendishCampusDescription"] = description
        newPost["cavendishCampusDate"] = date
        newPost["cavendishCampusCreatedDateTime"] = dateTime
