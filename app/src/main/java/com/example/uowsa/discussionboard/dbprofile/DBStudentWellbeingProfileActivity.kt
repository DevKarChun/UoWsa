package com.example.uowsa.discussionboard.dbprofile
...
import com.example.uowsa.activity.FriendsActivity
...
class DBStudentWellbeingProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dbstudent_wellbeing_profile)
    ...
    private fun declineFriendList() {
        ...
        val intentFriendRequest = Intent(this, DBStudentWellbeingActivity::class.java)
