...
class DBMakeNewFriendsProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_dbmake_new_friends_profile)
    ...
    private fun declineFriendList() {
        ...
        val intentFriendRequest = Intent(this, DBMakeNewFriendsActivity::class.java)
