...
class StudyNewForumActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_study_new_forum)
        ...
        submitBtn.setOnClickListener {
            if (titleTxt.text.toString().isEmpty()){
                ...
                val intentStudy = Intent(this@StudyNewForumActivity, ForumStudyActivity::class.java)
    ...
    private fun createStudyForum(title: String, description: String) {
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("StudyForum")
        Log.d("tagdatabaseref", databaseRef.toString())

        val newPost : HashMap <String, String> = HashMap()
        newPost["creatorId"] = userId
        newPost["studyTitle"] = title
        newPost["studyDescription"] = description
        newPost["studyDate"] = date
        newPost["createdDateTime"] = dateTime
