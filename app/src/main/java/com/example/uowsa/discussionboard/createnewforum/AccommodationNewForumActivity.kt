...
class AccommodationNewForumActivity : AppCompatActivity() {
    private lateinit var auth: FirebaseAuth

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_accommodation_new_forum)
        ...
        submitBtn.setOnClickListener {
            if (titleTxt.text.toString().isEmpty()){
                ...
                createAccommodationForum(title, description)
                val intentStudy = Intent(this@AccommodationNewForumActivity, ForumAccommodationActivity::class.java)
    ...
    private fun createAccommodationForum(title: String, description: String) {
        Log.d("tag", "testing")
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("AccommodationForum")
        Log.d("tagdatabaseref", databaseRef.toString())

        val newPost : HashMap <String, String> = HashMap()
        newPost["accommodationCreatorId"] = userId
        newPost["accommodationTitle"] = title
        newPost["accommodationDescription"] = description
        newPost["accommodationDate"] = date
        newPost["accommodationCreatedDateTime"] = dateTime
