...
class HarrowCampusNewForumActivity : AppCompatActivity() {

    private lateinit var auth: FirebaseAuth

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_harrow_campus_new_forum)
        ...
        submitBtn.setOnClickListener {
            if (titleTxt.text.toString().isEmpty()){
                ...
                createHarrowCampusForum(title, description)
                val intentStudy = Intent(this@HarrowCampusNewForumActivity, ForumHarrowCampusActivity::class.java)
    ...
    private fun createHarrowCampusForum(title: String, description: String) {
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("HarrowCampusForum")
        Log.d("tagdatabaseref", databaseRef.toString())

        val newPost : HashMap <String, String> = HashMap()
        newPost["harrowCampusCreatorId"] = userId
        newPost["harrowCampusTitle"] = title
        newPost["harrowCampusDescription"] = description
        newPost["harrowCampusDate"] = date
        newPost["harrowCampusDateTime"] = dateTime
