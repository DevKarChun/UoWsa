...
class ClubsAndSocietiesNewForumActivity : AppCompatActivity() {

    private lateinit var auth: FirebaseAuth

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_clubs_and_societies_new_forum)
        ...
        submitBtn.setOnClickListener {
            if (titleTxt.text.toString().isEmpty()){
                ...
                createClubsAndSocietiesForum(title, description)
                val intentStudy = Intent(this@ClubsAndSocietiesNewForumActivity, ForumClubsAndSocietiesActivity::class.java)
    ...
    private fun createClubsAndSocietiesForum(title: String, description: String) {
        ...
        val databaseRef = FirebaseDatabase.getInstance().getReference("ClubsAndSocietiesForum")
        Log.d("tagdatabaseref", databaseRef.toString())

        val newPost : HashMap <String, String> = HashMap()
        newPost["clubsAndSocietiesCreatorId"] = userId
        newPost["clubsAndSocietiesTitle"] = title
        newPost["clubsAndSocietiesDescription"] = description
        newPost["clubsAndSocietiesDate"] = date
        newPost["clubsAndSocietiesCreatedDateTime"] = dateTime
